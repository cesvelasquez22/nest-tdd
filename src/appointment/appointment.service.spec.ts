...
describe('AppointmentService', () => {
  ...
  it('should schedule and unconfirmed appointment for a user on success', async () => {
  ...
  it('should throw an error when end time is in same day, hour and month of next year', async () => {
    const startTime = new Date('2022-01-01T14:00:00Z');
